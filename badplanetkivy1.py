...
class PongGame(Widget):
    ...
    def collisionEngine(self):
        ...
        self.bullet4.distanceAlienshipToPlanet = self.eucDistance(self.bullet4.pos[0],self.bullet4.pos[1],self.alienship3.pos[0],self.alienship3.pos[1])
    ...
    def update(self, dt):
        ...
        if self.bullet4.collisionAlienship == 0 and self.bullet4.distanceAlienshipToPlanet<30:
